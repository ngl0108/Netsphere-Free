...
- Generated (UTC): `2026-03-09 03:52:36`
- Readiness Status: `critical`
- Required Checks: `18`
- Pass / Fail / Unknown: `8` / `7` / `3`
...
| `autonomy_issues_created` | `0` | `20` |
| `change_events` | `0` | `60` |
| `discovery_jobs` | `0` | `30` |
| `northbound_deliveries` | `12` | `500` |

## Sample Coverage Ratios

| Metric | Observed | Threshold | Coverage % | Met |
|---|---:|---:|---:|---|
| `autonomy_actions_executed` | `0` | `20` | `0.00` | `False` |
| `autonomy_issues_created` | `0` | `20` | `0.00` | `False` |
| `change_events` | `0` | `60` | `0.00` | `False` |
| `discovery_jobs` | `0` | `30` | `0.00` | `False` |
| `northbound_deliveries` | `12` | `500` | `2.40` | `False` |
...
| `plug_scan.auto_reflection_rate_pct` | `fail` | `0.00` | `75.00` | `True` | `discovery.kpi.summary` |
| `plug_scan.false_positive_rate_pct` | `pass` | `0.00` | `10.00` | `True` | `discovery.kpi.summary` |
...
| `sample.discovery.jobs_count` | `fail` | `0` | `30` | `True` | `ops.kpi.readiness.sample_gate` |
| `sample.change.events` | `fail` | `0` | `60` | `True` | `ops.kpi.readiness.sample_gate` |
| `sample.northbound.deliveries` | `fail` | `12` | `500` | `True` | `ops.kpi.readiness.sample_gate` |
| `sample.autonomy.issues_created` | `fail` | `0` | `20` | `True` | `ops.kpi.readiness.sample_gate` |
