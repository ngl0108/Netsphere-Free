...
- Generated (UTC): `2026-03-09 03:51:59`
...
| `northbound_deliveries` | `9` | `500` | `1.80` | `False` |
...
| `sample.northbound.deliveries` | `fail` | `9` | `500` | `True` | `ops.kpi.readiness.sample_gate` |
