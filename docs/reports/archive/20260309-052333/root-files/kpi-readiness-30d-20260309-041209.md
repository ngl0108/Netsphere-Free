...
- Generated (UTC): `2026-03-09 04:12:09`
- Readiness Status: `insufficient_data`
- Required Checks: `18`
- Pass / Fail / Unknown: `17` / `0` / `1`
...
| `northbound_deliveries` | `535` | `500` | `107.00` | `True` |
...
| `northbound.success_rate_pct` | `pass` | `99.25` | `95.00` | `True` | `sdn.dashboard.stats.northbound_kpi` |
...
| `sample.northbound.deliveries` | `pass` | `535` | `500` | `True` | `ops.kpi.readiness.sample_gate` |
