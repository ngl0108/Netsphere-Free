...
- Generated (UTC): `2026-02-17 14:22:46`
- Readiness Status: `critical`
- Required Checks: `18`
- Pass / Fail / Unknown: `9` / `6` / `3`
...
| `sample.discovery.jobs_count` | `pass` | `17` | `1` | `True` | `ops.kpi.readiness.sample_gate` |
| `sample.change.events` | `fail` | `0` | `1` | `True` | `ops.kpi.readiness.sample_gate` |
| `sample.northbound.deliveries` | `fail` | `0` | `1` | `True` | `ops.kpi.readiness.sample_gate` |
| `sample.autonomy.issues_created` | `pass` | `11` | `1` | `True` | `ops.kpi.readiness.sample_gate` |
| `sample.autonomy.actions_executed` | `fail` | `0` | `1` | `True` | `ops.kpi.readiness.sample_gate` |
